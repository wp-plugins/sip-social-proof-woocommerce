...
$extensions = array(
    '1' => (object) array(
        ...
        'url'       => SIP_SP_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SP_PLUGIN_VERSION .'&utm_campaign=' .SP_UTM_CAMPAIGN,
        'title'     => SIP_SP_PLUGIN,
        'desc'      => __( 'Display real time proof of your sales and customers.<br>', 'sip-social-proof' ),
    ),
    '2' => (object) array(
        'image_url' => $src_image . 'icon-woobundler.png',
        'url'       => SIP_WB_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SP_PLUGIN_VERSION .'&utm_campaign=' .SP_UTM_CAMPAIGN,
        'title'     => SIP_WB_PLUGIN,
        'desc'      => __( 'Bundle maker with real time offers.<br><br>', 'sip-social-proof' ),
    ),
    '3' => (object) array(
        'image_url' => $src_image . 'icon-wooreviews.png',
        'url'       => SIP_WR_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_SP_PLUGIN_VERSION .'&utm_campaign=' .SP_UTM_CAMPAIGN,
        'title'     => SIP_WR_PLUGIN,
